...
class HFModels:
    def __init__(
        ...
        try:
            ...
            self.generator_error = str(exc)
            print(f"[HFModels] Generator unavailable, using deterministic fallback: {exc}")
    ...
    def generate_raw(self, full_prompt: str) -> str:
        ...
        if self.generator is None:
            raise RuntimeError(self.generator_error or "Generator model is unavailable.")
